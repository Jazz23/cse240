...
class SnakeGame:
    ...
    def __init__(self, args):
        self.args = args
        self.env = BoardEnv(args.snake_head_x,
                            args.snake_head_y, args.food_x, args.food_y)
        self.agent = SnakeAgent(self.env.get_actions(),
                                args.Ne, args.LPC, args.gamma)
    ...
    def show_games(self):
        ...
        for game in range(1, self.args.NUM_DISP_ITER + 1):
            ...
            print("Game:", str(game)+"/" +
                  str(self.args.NUM_DISP_ITER), "Points:", points)
